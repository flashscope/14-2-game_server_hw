...
{
	TimerJobElement(SyncExecutablePtr owner, const TimerTask& task, uint64_t execTick)
...
public:
	...
	void PushTimerJob(SyncExecutablePtr owner, const TimerTask& task, uint64_t after);
