...
namespace MyPacket
{
	...
	public:
		...
		// required .MyPacket.MessageType messageType = 1;
		inline bool has_messagetype() const;
		inline void clear_messagetype();
		static const int kMessageTypeFieldNumber = 1;
		inline MyPacket::MessageType messagetype() const;
		inline void set_messagetype( MyPacket::MessageType value );

		// required int32 messageSize = 2;
		inline bool has_messagesize() const;
		inline void clear_messagesize();
		static const int kMessageSizeFieldNumber = 2;
		inline ::google::protobuf::int32 messagesize() const;
		inline void set_messagesize( ::google::protobuf::int32 value );

		// @@protoc_insertion_point(class_scope:MyPacket.PacketHeader)
	private:
		inline void set_has_messagetype();
		inline void clear_has_messagetype();
		inline void set_has_messagesize();
		inline void clear_has_messagesize();

		int messagetype_;
		::google::protobuf::int32 messagesize_;
	...
	// required .MyPacket.MessageType messageType = 1;
	inline bool PacketHeader::has_messagetype() const
	{
		return ( _has_bits_[0] & 0x00000001u ) != 0;
	}
	inline void PacketHeader::set_has_messagetype()
	{
		_has_bits_[0] |= 0x00000001u;
	}
	inline void PacketHeader::clear_has_messagetype()
	{
		_has_bits_[0] &= ~0x00000001u;
	}
	inline void PacketHeader::clear_messagetype()
	{
		messagetype_ = 1;
		clear_has_messagetype();
	}
	inline MyPacket::MessageType PacketHeader::messagetype() const
	{
		return static_cast<MyPacket::MessageType>( messagetype_ );
	}
	inline void PacketHeader::set_messagetype( MyPacket::MessageType value )
	{
		GOOGLE_DCHECK( MyPacket::MessageType_IsValid( value ) );
		set_has_messagetype();
		messagetype_ = value;
	}

	// required int32 messageSize = 2;
	inline bool PacketHeader::has_messagesize() const
	{
		return ( _has_bits_[0] & 0x00000002u ) != 0;
	}
	inline void PacketHeader::set_has_messagesize()
	{
		_has_bits_[0] |= 0x00000002u;
	}
	inline void PacketHeader::clear_has_messagesize()
	{
		_has_bits_[0] &= ~0x00000002u;
	}
	inline void PacketHeader::clear_messagesize()
	{
		messagesize_ = 0;
		clear_has_messagesize();
	}
	inline ::google::protobuf::int32 PacketHeader::messagesize() const
	{
		return messagesize_;
	}
	inline void PacketHeader::set_messagesize( ::google::protobuf::int32 value )
	{
		set_has_messagesize();
		messagesize_ = value;
	}
