...
#ifndef _MSC_VER
	const int PacketHeader::kMessageTypeFieldNumber;
	const int PacketHeader::kMessageSizeFieldNumber;
#endif  // !_MSC_VER
				...
				case 1: {
						 ...
						 ::google::protobuf::internal::WireFormatLite::WIRETYPE_VARINT )
					{
						...
						DO_( ( ::google::protobuf::internal::WireFormatLite::ReadPrimitive<
							...
							input, &value ) ) );
						if ( MyPacket::MessageType_IsValid( value ) )
						{
							set_messagetype( static_cast<MyPacket::MessageType>( value ) );
						}
					}
					else
					{
					...
					if ( input->ExpectTag( 16 ) ) goto parse_messageSize;
					break;
				}
...
#undef DO_
		...
		::google::protobuf::io::CodedOutputStream* output ) const
	{
		...
		if ( has_messagesize() )
		{
			::google::protobuf::internal::WireFormatLite::WriteInt32( 2, this->messagesize(), output );
		}
	...
	void PacketHeader::Swap( PacketHeader* other )
	{
		if ( other != this )
		{
			...
			std::swap( messagesize_, other->messagesize_ );
